                                                    ...
                                                    <td valign="top" style="padding-bottom: 0px;">
                                                        ...
                                                        <div  style="color:#000000;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left;margin-top: 30px">
                                                            ...
                                                            <table width="100%">
                                                                ...
                                                                <tr>
                                                                    <td>Service Rate</td>
                                                                    <td>{{$value->qty}} x {{$value->hourly_rate}} JOD</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Booking Date</td>
                                                                ...
                                                                <tr>
                                                                    <td>Total</td>
                                                                    <td>{{$value->hourly_rate * $value->qty}}  JOD</td>
                                                                </tr>
                                                                @if($value->discount)
                                                                <tr>
                                                                    <td>Discount</td>
                                                                    <td>{{$value->discount}} JOD</td>
                                                                </tr>
                                                                @endif
                                                                <tr>
                                                                    <td>VAT</td>
                                                                ...
                                                                <tr>
                                                                    <td>Grand Total</td>
                                                                    <td>{{(($value->hourly_rate * $value->qty) - $value->discount) +  $value->vat}}  JOD</td>
                                                                </tr>
                                                                @endforeach
