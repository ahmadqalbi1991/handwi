        ...
        <table class="table table-condensed table-striped ma7zouz-tables" id="example2">
            ...
            <tbody>
                ...
                @foreach($countries as $country) 
                    ...
                    <tr>
                        <td>{{$i}}</td>
                        <td>{{$country->countries_nice_name}}</td>
                        <td>+{{$country->countries_phonecode}}</td>
                        <td>@if($country->country_status) Active @else Inactive @endif</td>
                        <td class="text-center">
                            <div class="dropdown custom-dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink7">
                                    <a class="dropdown-item" href="{{url('admin/country/'.$country->countries_id.'/edit')}}"><i class="flaticon-pencil-1"></i> Edit</a>

                                    <a class="dropdown-item" data-role="unlink"
                                    data-message="Do you want to remove this country?"
                                    href="{{ url('admin/country/' . $country->countries_id) }}"><i
